...
public class NewWebService {
    ...
    public Person[] getPerson(Person[] person){
        ...
        System.out.println("WebApplicationExample Creata la persona Mario Rossi Via romaaaaaaaaaaaaaaaaaaaa");
        ...
        System.out.println("WebApplicationExample Creata la persona Paolo Biianchi Via milanoooooo");

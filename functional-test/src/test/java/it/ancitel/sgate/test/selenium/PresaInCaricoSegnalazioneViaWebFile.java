 ...
 * @author kewell
 */
public class PresaInCaricoSegnalazioneViaWebFile extends SgateSeleneseTestCase implements SeleniumNavigation{
	...
	public Selenium executeNavigation(Properties prop) throws Exception {
		...
		selenium.type("idLotto", prop.getProperty("idLottoGenerazioneRich2"));

 ...
 * @author kewell
 */
public class InvalidazioneViaWeb extends SgateSeleneseTestCase implements SeleniumNavigation{
	...
	public Selenium executeNavigation(Properties prop) throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.type("esitoRichiestaBean.motivazione", "Non validata");
		selenium.click("nonValida");
		selenium.waitForPageToLoad("30000");

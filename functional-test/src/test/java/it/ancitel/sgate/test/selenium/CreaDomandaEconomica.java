...
public class CreaDomandaEconomica extends SgateSeleneseTestCase implements SeleniumNavigation{
	...
	public Selenium executeNavigation(Properties prop) throws Exception {
        ...
        if (prop.getProperty("numerositaFamigliaAnagrafica") != null) {
            selenium.type("numCompFamAnag", prop.getProperty("numerositaFamigliaAnagrafica"));
        } else {
		...
		// Pagina 4..
        if (prop.getProperty("noComponentiNucleo") != null) {
            selenium.type("attestazioneIseeBean.numCompNucleoFamigl", prop.getProperty("noComponentiNucleo"));
        } else {
        ...
        while (prop.getProperty("codiceFiscaleFiglio"+i) != null ) {
            selenium.type("attestazioneIseeBean.codFiscale", prop.getProperty("codiceFiscaleFiglio"+i));
            selenium.click("_aggiungi");
            selenium.waitForPageToLoad("30000");
            selenium.click("attestazioneIseeBean.codFiscaliList[" + i + "].figlioACarico1");
            i++;
        }

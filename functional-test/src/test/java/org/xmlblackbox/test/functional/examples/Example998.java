 ...
 * @author Crea
 */
public class Example998 extends FlowControl{
    private final static Logger log = Logger.getLogger(Example998.class);

    public Example998(String msg) {
        super(msg);
    }

    public static Test suite() {
    	log.info("Log del TestCase Example999");
        TestSuite suite= new TestSuite(Example998.class);
        return suite;
    }

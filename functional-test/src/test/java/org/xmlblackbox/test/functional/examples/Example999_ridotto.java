 ...
 * @author Crea
 */
public class Example999_ridotto extends FlowControl{
    private final static Logger log = Logger.getLogger(Example999_ridotto.class);

    public Example999_ridotto(String msg) {
        super(msg);
    }

    public static Test suite() {
    	log.info("Log del TestCase Example999");
        TestSuite suite= new TestSuite(Example999_ridotto.class);
        return suite;
    }
